...
/* method id 403 */ C1 ();
/* method id 404 */ virtual void*** func0 (abstract_0*** v41, abstract_0*** v42, abstract_0*** v43);
/* method id 405 */ virtual abstract_0*** func0 (abstract_0*** v44);
...
/* method id 410 */ virtual void*** func0 (abstract_0*** v87, abstract_0*** v88, C2 v89);
C3 (special_constructor);
};
void* func2 (C2 v120, C2 v121, C2 v122, C2 v123);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C2 ());
return;
...
/* method id 404 */ void*** C1::func0 (abstract_0*** v41, abstract_0*** v42, abstract_0*** v43) {
return new void** ();

}
/* method id 405 */ abstract_0*** C1::func0 (abstract_0*** v44) {
...
/* method id 410 */ void*** C3::func0 (abstract_0*** v87, abstract_0*** v88, C2 v89) {
C2 v90 = *(&(*((new C2 ()))));
C2 v91 = *(&(*((new C2 ()))));
C2 v92 = *(&(*((new C2 ()))));
C2 v93 = *(&(*((new C2 ()))));
...
0    +---
0    | {vfptr}
4    | var0: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
8    | var1: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
12   | var2: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
16   | var3: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
20   +---
*/
{
...
24   | {vfptr}
28   | var0: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
32   | var1: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
36   | var2: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
40   | var3: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
44   +---
*/
{
...
32   | {vfptr}
36   | {vbptr}
40   | var48: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
44   | var49: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
48   | var50: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
52   | var51: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
56   +---
*/
{
...
52   | {vbptr}
56   | var66: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
60   | var67: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
64   +---
*/
{

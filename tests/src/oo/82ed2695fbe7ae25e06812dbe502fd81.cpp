...
/* method id 406 */ C0 func1 (C0* v29, abstract_0 v30);
C2 (special_constructor);
};
struct C3 : public C0, public virtual C1 {
/* method id 407 */ virtual C0 func0 (C1 v35, abstract_0 v36);
/* method id 408 */ virtual C0 func1 (C0* v41, C0* v42);
...
C0* v31 = &(((new C1 ()))->C1::func0((new C0 ()), ((C0*) 0)));
C1 v32 = *(&(*((new C1 ()))));
C0* v33 = ((C0*) 0);
C0* v34 = ((C0*) 0);
return (((C1*) 0))->C1::func0((new C0 ()), (new C0 ()));

}
C2::C2 (special_constructor) : C1(special_constructor ()), C0(special_constructor ()) {}

/* method id 407 */ C0 C3::func0 (C1 v35, abstract_0 v36) {
C1 v37 = *(((C1*) 0));
C1 v38 = *(((C1*) 0));
C0* v39 = ((C0*) 0);
C0* v40 = ((C0*) 0);
...
/* method id 408 */ C0 C3::func1 (C0* v41, C0* v42) {
C1 v43 = *((new C1 ()));
C0* v44 = ((C0*) 0);
C0* v45 = ((C0*) 0);
C0* v46 = ((C0*) 0);
return ((new C1 ()))->C1::func0(v45, v45);
...
16   | var12: PtrType{ClassType{0}}
20   | var13: PtrType{ClassType{0}}
24   +---
*/
{
...
4    | +---
4    | {vbptr}
8    | var52: PtrType{ClassType{0}}
12   | var53: AbstractType{0}
16   | var54: PtrType{ClassType{0}}
20   | var55: PtrType{ClassType{0}}
24   +---

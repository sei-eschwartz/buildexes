...
C0 func2 ();
C0 func3 (C0* v157, abstract_1 v158);
C0** func4 ();
C0*** func5 (C0* v166, abstract_0 v167, C1 v168, abstract_0 v169);
// definitions
/* method id 400 */ C0::C0 () {
...
((new C1 ()))->C1::func0(((C0*) 0), v160);
return ((new C3 ()))->C3::func0(v158, abstract_0());
...
4    | +---
4    | {vbptr}
8    | var155: PtrType{ClassType{0}}
12   | var156: AbstractType{0}
16   +---

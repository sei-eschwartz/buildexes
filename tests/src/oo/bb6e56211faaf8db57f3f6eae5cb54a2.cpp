...
/* method id 405 */ C1 ();
/* method id 406 */ virtual abstract_1* func0 (abstract_0 v42);
...
abstract_1 func7 ();
abstract_1* func8 (abstract_0 v53, abstract_0 v54, C3 v55, C3 v56);
abstract_1* func9 (abstract_0 v58, abstract_2 v59, C3 v60, abstract_0 v61);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 406 */ abstract_1* C1::func0 (abstract_0 v42) {
return ((abstract_1*) 0);
...
0    | {vfptr}
4    | {vbptr}
8    | var47: AbstractType{0}
12   | var48: AbstractType{0}
...
36   | {vfptr}
40   | {vbptr}
44   | var43: AbstractType{0}
48   +---
48   +--- (virtual base class C2)
48   | {vfptr}
52   | {vbptr}
56   | var47: AbstractType{0}
60   | var48: AbstractType{0}
64   +---
*/
{

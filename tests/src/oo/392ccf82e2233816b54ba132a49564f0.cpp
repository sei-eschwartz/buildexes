...
/* method id 408 */ abstract_0 func1 (abstract_1* v15, abstract_2 v16, C1 v17);
...
abstract_1 func4 ();
abstract_1 func5 (abstract_2 v44, C2 v45);
abstract_1 func6 (abstract_2 v49, C2 v50, abstract_2 v51, abstract_1* v52);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 408 */ abstract_0 C2::func1 (abstract_1* v15, abstract_2 v16, C1 v17) {
...
return ::func6(v47, v48, v47, new abstract_1 ());

}
abstract_1 func6 (abstract_2 v49, C2 v50, abstract_2 v51, abstract_1* v52) {
C1 v53;

return ::func5(v51, v50);
...
0    +---
0    | {vfptr}
4    | var20: PtrType{AbstractType{1}}
8    | var21: ClassType{1}
20   | var22: ClassType{1}
32   +---
*/
{
...
0    | | {vbptr}
4    | +---
4    | var37: AbstractType{2}
8    | var38: ClassType{1}
20   | var39: AbstractType{2}
24   | var40: ClassType{2}
56   +---
56   +--- (virtual base class C2)
56   | {vfptr}
60   | var20: PtrType{AbstractType{1}}
64   | var21: ClassType{1}

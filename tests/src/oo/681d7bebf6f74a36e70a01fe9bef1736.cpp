...
void** v2 = new void* ();
delete (new C2 ());
return ((new C1 ()))->C1::func0(v0, v0, v0);
...
8    | +--- (base class C0)
8    | +---
8    | var12: DeletablePtrType{PtrType{VoidType{}}}
12   | var13: DeletablePtrType{PtrType{VoidType{}}}
16   +---
16   +--- (virtual base class C2)
16   | {vbptr}
20   | var14: DeletablePtrType{PtrType{VoidType{}}}
24   | var15: DeletablePtrType{PtrType{VoidType{}}}
28   +---
*/
{

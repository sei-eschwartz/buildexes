...
/* method id 410 */ abstract_4 func3 (abstract_1 v30);
/* method id 411 */ C2 ();
...
abstract_4 func6 (abstract_0 v39, abstract_1 v40, abstract_3 v41, abstract_1 v42);
abstract_2 func7 (abstract_6 v45, abstract_2* v46, abstract_6 v47, abstract_2* v48);
abstract_2 func8 (C3 v53, abstract_5 v54, abstract_7 v55);
abstract_4** func9 (abstract_2* v56, abstract_3 v57);
// definitions
...
return ::func8(*((new C3 ())), abstract_5(), abstract_7());
...
/* method id 410 */ abstract_4 C2::func3 (abstract_1 v30) {
return abstract_4();
...
0    | {vfptr}
4    | {vbptr}
8    | var31: AbstractType{7}
12   | var32: AbstractType{5}
...
32   | {vbptr}
36   | var20: PtrType{AbstractType{2}}
...
0    +---
0    | {vbptr}
4    | var35: PtrType{AbstractType{2}}
8    | var36: PtrType{AbstractType{2}}
12   | var37: PtrType{AbstractType{2}}
16   | var38: PtrType{AbstractType{2}}
...
28   | {vbptr}
32   | var20: PtrType{AbstractType{2}}
...
44   | {vfptr}
48   | {vbptr}
52   | var31: AbstractType{7}
56   | var32: AbstractType{5}
60   | var33: AbstractType{1}
64   | var34: AbstractType{1}
68   +---
*/
{

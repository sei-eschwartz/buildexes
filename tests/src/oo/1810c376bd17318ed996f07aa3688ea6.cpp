...
abstract_0* func2 (C0* v60, C0* v61);
abstract_0* func3 (C0* v65, C0* v66, C0* v67, C0* v68);
abstract_0* func4 (C0* v72, C0* v73);
abstract_10 func5 (abstract_17 v78);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C3 ());
return;
...
/* method id 409 */ C3::C3 () {
C0* v47 = ((C0*) 0);
C0* v48 = &((((C1*) 0))->C1::func0((new C0 ()), (new C0 ())));
delete (new C3 ());
return;
...
24   | | +---
24   | +---
24   | var57: PtrType{ClassType{0}}
28   | var58: PtrType{ClassType{0}}
32   | var59: PtrType{ClassType{0}}
36   +---

...
/* method id 405 */ C0* func3 (C0* v9, abstract_0* v10);
/* method id 406 */ C1 ();
...
abstract_0 func6 (abstract_2 v64, C0* v65, C0* v66, C0*** v67);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 405 */ C0* C1::func3 (C0* v9, abstract_0* v10) {
v9 = ((C0*) 0);
return ((C0*) 0);
...
4    | | {vbptr}
8    | +---
8    | var63: PtrType{AbstractType{0}}
12   +---

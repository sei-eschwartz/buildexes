...
/* method id 411 */ C3 ();
/* method id 412 */ void** func0 (abstract_0 v24, void**** v25, abstract_1 v26, abstract_1 v27);
/* method id 413 */ ~C3 ();
C3 (special_constructor);
C1 v39;
C1 v40;
};
void** func5 (abstract_0 v41, C1 v42, C1 v43, void**** v44);
void** func6 (C1 v49, C1 v50);
C0 func7 ();
abstract_2 func8 (C1 v52);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C2 ());
return;
...
/* method id 412 */ void** C3::func0 (abstract_0 v24, void**** v25, abstract_1 v26, abstract_1 v27) {
return new void* ();
...
108  | | var22: ClassType{1}
136  | +---
136  | var39: ClassType{1}
164  | var40: ClassType{1}
192  +---
192  +--- (virtual base class C0)
192  | {vfptr}
196  +---
*/
{

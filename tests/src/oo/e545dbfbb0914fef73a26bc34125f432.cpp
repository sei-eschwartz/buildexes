...
/* method id 411 */ virtual abstract_1** func0 (C1 v137, C1 v138, abstract_0 v139, C1 v140);
C3 (special_constructor);
C1 v148;
C1 v149;
C1 v150;
};
abstract_1 func3 (C1 v151, C1 v152, C1 v153, C1 v154);
// definitions
/* method id 400 */ C0::~C0 () {
...
/* method id 411 */ abstract_1** C3::func0 (C1 v137, C1 v138, abstract_0 v139, C1 v140) {
C1 v141 = *((new C1 ()));
C1 v142 = *((new C1 ()));
...
0    | {vfptr}
4    | {vbptr}
8    | var148: ClassType{1}
32   | var149: ClassType{1}
56   | var150: ClassType{1}
80   +---
...
88   | +---
88   | var20: AbstractType{0}
92   | var21: AbstractType{0}
96   | var22: AbstractType{0}
100  | var23: AbstractType{0}
104  +---
*/
{

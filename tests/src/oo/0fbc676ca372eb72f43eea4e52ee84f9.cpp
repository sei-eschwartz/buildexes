...
/* method id 410 */ void* func3 ();
/* method id 411 */ virtual void func0 (abstract_2 v18);
/* method id 412 */ C3 ();
...
/* method id 411 */ void C3::func0 (abstract_2 v18) {
C0** v19 = ((C0**) 0);
C2 v20 = *(((C2*) 0));
return;
...
20   | {vfptr}
24   | {vbptr}
28   | var13: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}
32   +---
*/
{

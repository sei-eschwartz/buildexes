...
/* method id 403 */ abstract_0 func2 (C0 v3, C0 v4, C1 v5);
/* method id 404 */ C2 ();
...
abstract_0 func5 ();
abstract_2 func6 (C0 v17, C0 v18);
// definitions
/* method id 400 */ C0::C0 () {
...
/* method id 403 */ abstract_0 C2::func2 (C0 v3, C0 v4, C1 v5) {
...
28   | +--- (base class C1)
28   | | {vfptr}
32   | | var0: PtrType{AbstractType{0}}
36   | | var1: ClassType{0}
37   | | alignment: 

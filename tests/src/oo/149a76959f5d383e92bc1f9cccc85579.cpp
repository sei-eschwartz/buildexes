...
/* method id 403 */ abstract_0* func1 (abstract_0** v12, abstract_0** v13, abstract_0*** v14, abstract_0*** v15);
/* method id 404 */ C0 ();
...
/* method id 411 */ virtual abstract_0* func2 (abstract_0*** v75, abstract_2 v76);
...
abstract_0* func3 ();
abstract_0* func4 (abstract_0*** v97, abstract_0*** v98, abstract_0*** v99, abstract_0*** v100);
abstract_0* func5 (abstract_0*** v104, abstract_1 v105, abstract_0*** v106, abstract_0*** v107);
abstract_0* func6 (abstract_0*** v108, abstract_0*** v109);
// definitions
...
/* method id 403 */ abstract_0* C0::func1 (abstract_0** v12, abstract_0** v13, abstract_0*** v14, abstract_0*** v15) {
...
abstract_0*** v73 = new abstract_0** ();
abstract_0*** v74 = new abstract_0** ();
return;

}
/* method id 411 */ abstract_0* C3::func2 (abstract_0*** v75, abstract_2 v76) {
abstract_0*** v77 = new abstract_0** ();
abstract_0*** v78 = new abstract_0** ();
abstract_0*** v79 = new abstract_0** ();
...
0    +---
0    | {vfptr}
4    | var20: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
8    | var21: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
12   +---
*/
{
...
16   | var45: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
20   | var46: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
24   | var47: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
28   +---
*/
{
...
8    | | var21: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
12   | +---
12   | var92: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
16   | var93: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
20   | var94: AbstractType{2}
24   +---
*/
{

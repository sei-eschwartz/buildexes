...
/* method id 413 */ C3 ();
/* method id 414 */ abstract_4 func3 ();
/* method id 415 */ virtual void func1 ();
...
/* method id 414 */ abstract_4 C3::func3 () {
return abstract_4();

}
/* method id 415 */ void C3::func1 () {
abstract_10* v55 = new abstract_10 ();
return;
...
16   | {vfptr}
20   | {vbptr}
24   | var32: PtrType{AbstractType{2}}
28   | var33: AbstractType{1}
32   | var34: PtrType{PtrType{PtrType{AbstractType{4}}}}
36   +---
36   +--- (virtual base class C2)
36   | {vfptr}
40   | {vbptr}
44   | var40: AbstractType{1}
48   | var41: AbstractType{1}
52   | var42: PtrType{PtrType{PtrType{AbstractType{4}}}}
56   | var43: PtrType{PtrType{PtrType{AbstractType{4}}}}
60   +---
*/
{

...
abstract_0 func9 (C0 v23, abstract_2 v24);
abstract_0 func10 (C3 v29);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
delete (new C2 ());
return (((C1*) 0))->C1::func4(*((new C0 ())), v30);
...
16   | | var18: ClassType{1}
44   | +---
44   | var19: ClassType{0}
48   | var20: AbstractType{2}
52   | var21: AbstractType{1}
56   | var22: ClassType{0}
60   +---
...
64   | {vfptr}
68   | {vbptr}
72   | var12: ClassType{0}
76   | var13: ClassType{0}
80   | var14: PtrType{AbstractType{0}}
84   | var15: PtrType{AbstractType{0}}
88   +---
*/
{

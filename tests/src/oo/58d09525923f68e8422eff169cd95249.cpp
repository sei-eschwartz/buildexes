...
/* method id 408 */ virtual abstract_0*** func0 (C0* v47);
/* method id 409 */ virtual C0 func2 (abstract_0** v50, abstract_1 v51, abstract_1 v52, abstract_0** v53);
/* method id 410 */ C3 ();
...
/* method id 408 */ abstract_0*** C3::func0 (C0* v47) {
C0* v48 = &(*((new C0 ())));
abstract_0** v49 = new abstract_0* ();
return new abstract_0** ();

}
/* method id 409 */ C0 C3::func2 (abstract_0** v50, abstract_1 v51, abstract_1 v52, abstract_0** v53) {
abstract_1 v54 = abstract_1();
abstract_2 v55 = abstract_2();
C0* v56 = &((((C1*) 0))->C1::func0((new C0 ()), (new C0 ())));
...
0    | {vfptr}
4    | {vbptr}
8    | var66: DeletablePtrType{PtrType{AbstractType{0}}}
12   +---
...
16   | | {vfptr}
20   | | {vbptr}
24   | | var22: PtrType{ClassType{0}}
28   | | var23: PtrType{ClassType{0}}
32   | | var24: PtrType{ClassType{0}}
36   | | var25: PtrType{ClassType{0}}
40   | +---
40   +---
*/
{

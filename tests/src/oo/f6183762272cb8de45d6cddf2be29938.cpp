...
/* method id 406 */ virtual abstract_0* func0 (abstract_0**** v20);
/* method id 407 */ virtual abstract_0* func1 (abstract_1 v22);
/* method id 408 */ C2 ();
...
/* method id 406 */ abstract_0* C2::func0 (abstract_0**** v20) {
abstract_1 v21 = abstract_1();
return ((abstract_0*) 0);

}
/* method id 407 */ abstract_0* C2::func1 (abstract_1 v22) {
...
0    | {vfptr}
4    | {vbptr}
8    | var28: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
...
44   | var19: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
48   +---
*/
{
...
32   | var19: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
36   +---
*/
{

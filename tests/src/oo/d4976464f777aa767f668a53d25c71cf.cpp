...
C0* func6 (C0*** v133, C0* v134, C0* v135);
C0* func7 (C0*** v139, C0* v140, C0* v141, C0* v142);
C0* func8 (C0* v143);
C0* func9 (C0* v147, C0* v148, C0* v149, abstract_3 v150);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
0    +---
0    | {vbptr}
4    | var64: AbstractType{3}
8    | var65: PtrType{AbstractType{0}}
12   +---
...
0    +---
0    | {vbptr}
4    | var131: PtrType{ClassType{0}}
8    | var132: PtrType{ClassType{0}}
12   +---
12   +--- (virtual base class C0)
12   | {vfptr}
16   +---
...
32   | {vbptr}
36   | var64: AbstractType{3}
40   | var65: PtrType{AbstractType{0}}
44   +---
*/
{

...
void*** func6 (C2 v28, C2 v29, C1 v30, void**** v31);
void** func7 (abstract_1 v34, C1 v35, abstract_0 v36, C1 v37);
void** func8 ();
void** func9 (C1 v42);
// definitions
/* method id 400 */ C0::~C0 () {
...
void**** v18 = new void*** ();
delete (new C0 ());
return ::func7(abstract_1(), v21, abstract_0(), v21);
...
280  | var26: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}
284  | var27: AbstractType{0}
288  +---
288  +--- (virtual base class C0)
288  | {vfptr}
292  +---
*/
{

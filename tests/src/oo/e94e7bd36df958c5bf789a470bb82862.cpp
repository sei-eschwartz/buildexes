...
abstract_3 func6 (abstract_4 v122, C1 v123, abstract_4 v124, C1 v125);
abstract_3 func7 ();
abstract_1 func8 (abstract_0 v130);
abstract_1* func9 (C1 v135, abstract_5 v136, C1 v137, C1 v138);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
v108 = v120;
v108 = v120;
return ::func6(abstract_4(), v117, abstract_4(), v117);
...
32   | {vfptr}
36   | {vbptr}
40   | var87: AbstractType{0}
44   | var88: AbstractType{0}
48   | var89: AbstractType{0}
52   | var90: AbstractType{0}
56   +---
56   +--- (virtual base class C2)
56   | {vfptr}
60   | {vbptr}
64   | var105: ClassType{1}
112  | var106: ClassType{1}
160  | var107: ClassType{1}
208  | var108: ClassType{1}
256  +---
*/
{

...
/* method id 403 */ C2 ();
/* method id 404 */ void func0 (C0 v8, C0 v9);
...
void func2 (abstract_1 v20, C2 v21, C0 v22, C0 v23);
void func3 ();
void func4 (C0 v28, abstract_1 v29, void* v30, abstract_1 v31);
abstract_2 func5 (C1 v34, C1 v35, C1 v36, C1 v37);
// definitions
/* method id 400 */ C0::C0 () {
...
delete (new C2 ());
return ::func4(v27, v26, ((void*) 0), v26);
...
57   | alignment: 
60   | var13: PtrType{VoidType{}}
64   | var14: ClassType{0}
65   | var15: ClassType{0}
66   | alignment: 
68   +---
*/
{

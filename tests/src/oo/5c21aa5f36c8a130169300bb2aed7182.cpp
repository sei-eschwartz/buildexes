...
struct C3  {
/* method id 409 */ C3 ();
/* method id 410 */ virtual void** func6 (C1 v15);
/* method id 411 */ virtual ~C3 ();
/* method id 412 */ abstract_1** func1 ();
...
/* method id 410 */ void** C3::func6 (C1 v15) {
C1 v16 = *((C1*)(&(*((new C2 ())))));
(&(v16))->C1::func2(new void*** ());
(&(v16))->C1::func2(new void*** ());
(&(v16))->C1::func2(new void*** ());
(&(v16))->C1::func2(new void*** ());
return new void* ();
...
0    +---
0    | {vfptr}
4    | var25: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}
8    | var26: ClassType{2}
36   | var27: ClassType{2}
64   +---
*/
{

...
C0 func2 (abstract_5 v168, C0* v169, C0* v170, C0* v171);
C0 func3 (C0* v176, abstract_1 v177, C0* v178, C0* v179);
C0 func4 (C0* v181, abstract_5 v182, C0* v183, abstract_1 v184);
C0 func5 (C0* v188, C0* v189, abstract_0 v190, C0* v191);
// definitions
/* method id 400 */ C0::C0 () {
...
return ::func4(v171, v175, v171, v173);
...
delete (new C2 ());
return ::func3(v191, abstract_1(), v191, v191);
...
4    | | {vbptr}
8    | +---
8    | var165: PtrType{ClassType{0}}
12   | var166: PtrType{ClassType{0}}
16   | var167: AbstractType{5}
20   +---

...
/* method id 413 */ virtual void func3 ();
/* method id 414 */ C3 ();
C3 (special_constructor);
C1 v29;
abstract_0** v30;
};
abstract_1 func4 (C1 v31, C1 v32, C1 v33);
// definitions
...
4    | {vbptr}
8    | var29: ClassType{1}
32   | var30: PtrType{PtrType{AbstractType{0}}}
36   | {vtordisp for vbase 0}
40   +---
40   +--- (virtual base class C0)
40   | {vfptr}
44   | var4: PtrType{PtrType{AbstractType{0}}}
48   +---
48   +--- (virtual base class C1)
48   | {vbptr}
52   | var8: PtrType{PtrType{AbstractType{0}}}
56   | var9: PtrType{PtrType{AbstractType{0}}}
60   +---
60   +--- (virtual base class C2)
60   | {vfptr}
64   | var22: ClassType{1}

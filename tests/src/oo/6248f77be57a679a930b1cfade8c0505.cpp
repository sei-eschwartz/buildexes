...
56   | var32: ClassType{1}
80   | {vtordisp for vbase 0}
84   +---
84   +--- (virtual base class C0)
84   | {vfptr}
88   | var4: PtrType{PtrType{AbstractType{0}}}
92   +---
92   +--- (virtual base class C1)
92   | {vbptr}
96   | var8: PtrType{PtrType{AbstractType{0}}}
100  | var9: PtrType{PtrType{AbstractType{0}}}
104  +---
104  +--- (virtual base class C2)
104  | {vfptr}
108  | var22: ClassType{1}
132  | var23: ClassType{1}
156  +---
*/
{

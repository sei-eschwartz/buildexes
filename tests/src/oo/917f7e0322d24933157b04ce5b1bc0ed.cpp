...
/* method id 408 */ virtual C0 func2 (C0* v153, abstract_0 v154);
...
return (((C3*) 0))->C3::func2(v32, v5);

}
/* method id 408 */ C0 C3::func2 (C0* v153, abstract_0 v154) {
C0* v155 = ((C0*) 0);
return *(v153);
...
4    | | {vbptr}
8    | +---
8    | var156: AbstractType{3}
12   | var157: AbstractType{3}
16   | var158: PtrType{ClassType{0}}
20   | var159: AbstractType{4}
24   +---

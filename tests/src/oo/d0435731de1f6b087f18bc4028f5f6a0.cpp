...
/* method id 411 */ abstract_4 func3 (abstract_6 v34, abstract_0 v35);
/* method id 412 */ C2 ();
...
/* method id 411 */ abstract_4 C2::func3 (abstract_6 v34, abstract_0 v35) {
...
0    +---
0    | {vbptr}
4    | var38: PtrType{PtrType{AbstractType{4}}}
...
0    +---
0    | {vbptr}
4    | var50: PtrType{PtrType{AbstractType{4}}}
8    | var51: ClassType{1}
...
44   | {vbptr}
48   | var20: AbstractType{1}
52   | var21: AbstractType{5}
56   | var22: AbstractType{5}
60   | var23: AbstractType{5}
64   +---
64   +--- (virtual base class C2)
64   | {vbptr}
68   | var38: PtrType{PtrType{AbstractType{4}}}
72   | var39: AbstractType{1}
76   | var40: ClassType{1}
104  +---
*/
{

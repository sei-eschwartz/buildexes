...
/* method id 410 */ virtual abstract_0* func3 (abstract_4 v53, abstract_8 v54, abstract_8 v55, abstract_4 v56);
/* method id 411 */ C3 ();
C3 (special_constructor);
abstract_0** v61;
};
abstract_3 func6 (abstract_0** v62, abstract_0** v63, abstract_0** v64);
abstract_3 func7 ();
abstract_2 func8 (abstract_9 v69, abstract_0** v70, abstract_9 v71, abstract_0** v72);
// definitions
...
v10 = v10;
v10 = new abstract_0* ();
return ::func8(abstract_9(), ((abstract_0**) 0), abstract_9(), new abstract_0* ());
...
/* method id 410 */ abstract_0* C3::func3 (abstract_4 v53, abstract_8 v54, abstract_8 v55, abstract_4 v56) {
abstract_8 v57 = abstract_8();
abstract_9 v58 = abstract_9();
...
delete (new C1 ());
return ::func6(new abstract_0* (), new abstract_0* (), new abstract_0* ());
...
0    | {vfptr}
4    | {vbptr}
8    | var61: PtrType{PtrType{AbstractType{0}}}
12   | {vtordisp for vbase 0}
16   +---
16   +--- (virtual base class C0)
16   | {vfptr}

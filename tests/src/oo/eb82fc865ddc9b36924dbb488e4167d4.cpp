...
/* method id 409 */ void func1 (abstract_0* v18);
/* method id 410 */ C2 ();
...
delete (new C1 ());
return ((new C1 ()))->C1::func3((new C0 ()), ((abstract_0*) 0));

...
/* method id 409 */ C3 ();
/* method id 410 */ virtual abstract_1 func2 (abstract_0 v104);
...
abstract_1* func4 (C1 v110, C1 v111, abstract_0 v112, C1 v113);
abstract_1* func5 (C1 v118);
abstract_1* func6 (C1 v121, C1 v122, C1 v123, C1 v124);
void func7 (C1 v127, C1 v128, C1 v129, C1 v130);
// definitions
/* method id 400 */ C0::~C0 () {
...
/* method id 410 */ abstract_1 C3::func2 (abstract_0 v104) {
C1 v105 = *(((C1*) 0));
::func5(*((new C1 ())));
::func5(*((new C1 ())));
::func5(*((new C1 ())));
...
0    | {vfptr}
4    | {vbptr}
8    | var106: ClassType{1}
32   | var107: ClassType{1}
56   | var108: ClassType{1}
80   | var109: ClassType{1}
104  +---
104  +--- (virtual base class C1)
104  | +--- (base class C0)
104  | | {vfptr}
108  | | var7: AbstractType{0}
112  | +---
112  | var20: AbstractType{0}
116  | var21: AbstractType{0}
120  | var22: AbstractType{0}
124  | var23: AbstractType{0}
128  +---
*/
{

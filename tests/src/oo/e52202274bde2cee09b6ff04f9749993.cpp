...
/* method id 409 */ virtual abstract_2 func1 ();
...
/* method id 410 */ virtual abstract_4 func4 (abstract_1 v35, abstract_0 v36);
/* method id 411 */ virtual abstract_4* func2 ();
/* method id 412 */ C3 ();
...
abstract_4 func6 (abstract_0 v47);
// definitions
...
/* method id 409 */ abstract_2 C2::func1 () {
...
/* method id 410 */ abstract_4 C3::func4 (abstract_1 v35, abstract_0 v36) {
abstract_4* v37 = new abstract_4 ();
return ::func6(v33);

}
/* method id 411 */ abstract_4* C3::func2 () {
...
0    +---
0    | {vfptr}
4    | var32: AbstractType{0}
8    | var33: AbstractType{0}
12   | var34: AbstractType{5}
16   +---
*/
{
...
12   | var44: AbstractType{6}
16   | var45: AbstractType{6}
20   | var46: AbstractType{6}
...
32   | {vfptr}
36   | var32: AbstractType{0}
40   | var33: AbstractType{0}
44   | var34: AbstractType{5}
48   +---
48   +--- (virtual base class C1)
48   | {vbptr}
52   | var20: AbstractType{5}
56   +---
*/
{

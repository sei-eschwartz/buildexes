...
/* method id 404 */ C1 ();
/* method id 405 */ virtual C0 func0 (abstract_0* v8);
...
C0* func5 (C1 v19, abstract_1*** v20);
C0 func6 (C0* v22);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
...
return ::func5(*(((C1*) 0)), new abstract_1** ());
...
/* method id 405 */ C0 C1::func0 (abstract_0* v8) {
return ::func6(&(::func6((C0*)((new C3 ())))));
...
20   | var18: PtrType{AbstractType{0}}
24   +---

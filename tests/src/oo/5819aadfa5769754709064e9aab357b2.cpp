...
/* method id 404 */ C2 ();
/* method id 405 */ void func1 (C1 v22, C1 v23, C1 v24, C1 v25);
...
/* method id 405 */ void C2::func1 (C1 v22, C1 v23, C1 v24, C1 v25) {
C1 v26 = *(&(*((new C1 ()))));
C1 v27 = *(((C1*) 0));
C1 v28 = *(&(*((new C1 ()))));
C1 v29 = *(((C1*) 0));
...
8    | {vfptr}
12   | {vbptr}
16   | var30: ClassType{1}
18   | var31: ClassType{1}
20   +---
*/
{

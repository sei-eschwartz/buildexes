...
/* method id 408 */ C3 ();
/* method id 409 */ virtual void* func1 (void**** v27, void**** v28);
...
void* func5 (void**** v86);
void* func6 (C2 v88, C2 v89, C2 v90, C2 v91);
void* func7 (C2 v92, C2 v93);
// definitions
...
/* method id 409 */ void* C3::func1 (void**** v27, void**** v28) {
void**** v29 = new void*** ();
void**** v30 = new void*** ();
void**** v31 = new void*** ();
void**** v32 = new void*** ();
return ::func6(v85, v85, v85, v85);
...
4    | {vbptr}
8    | var83: ClassType{2}
64   | var84: ClassType{2}
120  | var85: ClassType{2}
176  +---
176  +--- (virtual base class C0)
176  | {vfptr}
180  | var12: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
184  | var13: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
188  | var14: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
192  | var15: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
196  +---
196  +--- (virtual base class C1)
196  | {vbptr}
200  | var16: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
204  | var17: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
208  | var18: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
212  | var19: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
216  +---
216  +--- (virtual base class C2)
216  | {vbptr}
220  | var20: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
224  | var21: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
228  | var22: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
232  +---
*/
{

...
/* method id 417 */ virtual abstract_2 func6 (abstract_6 v46);
/* method id 418 */ C3 ();
...
abstract_2 func8 (abstract_10 v53, C0 v54);
// definitions
...
delete (new C2 ());
return ::func8(abstract_10(), *((new C0 ())));
...
delete (new C3 ());
return (((C3*) 0))->C3::func6(abstract_6());
...
8    | | var28: AbstractType{1}
12   | +---
12   | var50: AbstractType{1}
16   | var51: AbstractType{0}
20   | var52: AbstractType{3}
24   +---
*/
{

...
C0* func7 ();
C0* func8 (C0* v21, abstract_0 v22);
C0 func9 (C0* v24, abstract_0 v25, abstract_0 v26);
C0 func10 (C0* v30, C3 v31);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
::func8(v24, abstract_0());
::func8(v24, abstract_0());
::func8(v24, abstract_0());
::func10(v24, *(((C3*) 0)));
return ::func10(v24, *(((C3*) 0)));
...
v33 = v33;
v33 = v33;
return ::func9(v34, abstract_0(), abstract_0());
...
24   | {vfptr}
28   | {vbptr}
32   | var6: PtrType{ClassType{0}}
36   +---
36   +--- (virtual base class C2)
36   | {vbptr}
40   | var15: AbstractType{0}
44   +---
*/
{

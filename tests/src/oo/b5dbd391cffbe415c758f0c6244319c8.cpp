...
/* method id 406 */ virtual abstract_0 func1 (abstract_1 v92, abstract_1 v93);
...
abstract_0** func3 (abstract_1 v155, abstract_1 v156, abstract_3 v157);
abstract_0* func4 (abstract_0*** v158, abstract_1 v159, C0 v160, abstract_0** v161);
// definitions
/* method id 400 */ C0::C0 () {
delete (new C1 ());
return;
...
v99 = v94;
return (((C1*) 0))->C1::func0(v9, v10);

}
C1::C1 (special_constructor) : C0(special_constructor ()) {}

/* method id 407 */ C2::C2 () {
abstract_2 v102 = abstract_2();
...
12   | var99: AbstractType{2}
16   | var100: AbstractType{1}
20   | var101: AbstractType{1}
24   +---
...
32   | {vfptr}
36   | {vbptr}
40   | var98: AbstractType{1}
44   | var99: AbstractType{2}
48   | var100: AbstractType{1}
52   | var101: AbstractType{1}
56   +---
*/
{
...
0    +---
0    | {vbptr}
4    | var152: DeletablePtrType{PtrType{AbstractType{0}}}
8    | var153: AbstractType{3}
12   | var154: AbstractType{1}
16   +---
16   +--- (virtual base class C0)
16   | {vfptr}
20   | var8: AbstractType{1}
...
56   | {vbptr}
60   | var110: AbstractType{1}
64   | var111: AbstractType{1}
68   | var112: AbstractType{1}
72   +---
*/
{

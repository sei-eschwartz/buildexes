...
/* method id 402 */ void func0 (C0 v1, abstract_1 v2, abstract_0* v3, void* v4);
...
/* method id 405 */ virtual abstract_0 func1 (void* v16);
/* method id 406 */ C2 ();
...
/* method id 402 */ void C1::func0 (C0 v1, abstract_1 v2, abstract_0* v3, void* v4) {
C0 v5 = *((new C0 ()));
...
/* method id 405 */ abstract_0 C2::func1 (void* v16) {
...
24   | {vfptr}
28   | var0: PtrType{AbstractType{0}}
32   +---
*/
{
...
32   | var21: ClassType{0}
40   | var22: PtrType{VoidType{}}
44   +---
44   +--- (virtual base class C0)
44   | {vfptr}
48   | var0: PtrType{AbstractType{0}}
52   +---
*/
{
...
16   | | var15: ClassType{0}
24   | +---
24   | var23: PtrType{VoidType{}}
28   | var24: PtrType{VoidType{}}
32   | var25: AbstractType{1}
36   +---
36   +--- (virtual base class C0)
36   | {vfptr}
40   | var0: PtrType{AbstractType{0}}
44   +---
*/
{

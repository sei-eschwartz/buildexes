...
struct C3 : public C0, public C1, public C2 {
/* method id 404 */ ~C3 ();
/* method id 405 */ abstract_0 func2 (abstract_0* v2, abstract_0* v3);
/* method id 406 */ C3 ();
...
/* method id 405 */ abstract_0 C3::func2 (abstract_0* v2, abstract_0* v3) {
C1 v4 = *((new C1 ()));

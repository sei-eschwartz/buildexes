...
abstract_0 func10 (C1 v23, abstract_0* v24);
abstract_0 func11 (C0 v25, C0 v26, C0 v27, C0 v28);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
return ::func10(v32, ((abstract_0*) 0));
...
8    | var20: PtrType{AbstractType{0}}
12   | var21: ClassType{1}
40   | var22: PtrType{AbstractType{0}}
44   +---
44   +--- (virtual base class C0)
44   | {vfptr}
48   +---
...
72   | {vfptr}
76   | {vbptr}
80   | var16: AbstractType{1}
84   | var17: ClassType{0}
88   | var18: ClassType{1}
116  +---
*/
{

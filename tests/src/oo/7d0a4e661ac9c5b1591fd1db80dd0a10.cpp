...
/* method id 410 */ virtual abstract_1* func5 (abstract_0 v114, C2 v115, C2 v116, C2 v117);
/* method id 411 */ C3 ();
...
void func6 (C2 v144, C2 v145, C2 v146, C2 v147);
abstract_1* func7 (C2 v152, C2 v153, C2 v154, C2 v155);
abstract_1* func8 (C2 v160, C2 v161, C2 v162, C2 v163);
void func9 (C2 v168, C2 v169, C2 v170, C2 v171);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 410 */ abstract_1* C3::func5 (abstract_0 v114, C2 v115, C2 v116, C2 v117) {
C2 v118 = *(&(*(((C2*) 0))));
C2 v119 = *(&(*(((C2*) 0))));
delete (new C1 ());
v140 = v140;
...
delete (new C2 ());
return ::func6(v168, v168, v170, v170);
...
0    | {vfptr}
4    | {vbptr}
8    | var98: AbstractType{0}
12   | var99: AbstractType{0}
16   | var100: AbstractType{0}
...
0    | {vfptr}
4    | {vbptr}
8    | var112: AbstractType{0}
12   | var113: AbstractType{0}
...
40   | {vfptr}
44   | {vbptr}
48   | var98: AbstractType{0}
52   | var99: AbstractType{0}
56   | var100: AbstractType{0}
60   +---
*/
{
...
0    | {vfptr}
4    | {vbptr}
8    | var140: ClassType{2}
68   | var141: ClassType{2}
128  | var142: ClassType{2}
188  | var143: ClassType{2}
...
272  | {vfptr}
276  | {vbptr}
280  | var98: AbstractType{0}
284  | var99: AbstractType{0}
288  | var100: AbstractType{0}
292  +---
292  +--- (virtual base class C2)
292  | {vfptr}
296  | {vbptr}
300  | var112: AbstractType{0}
304  | var113: AbstractType{0}
308  +---
*/
{

...
abstract_1 func4 (abstract_1** v131, abstract_1** v132, abstract_1** v133, abstract_1** v134);
abstract_1 func5 (abstract_1** v138, abstract_1** v139, abstract_1** v140);
abstract_1 func6 (abstract_1** v144, abstract_1** v145);
abstract_1 func7 (abstract_2 v150, abstract_1** v151, abstract_1** v152, abstract_1** v153);
// definitions
...
return ::func5(new abstract_1* (), new abstract_1* (), new abstract_1* ());
...
return (((C3*) 0))->C3::func1(abstract_0());

}
abstract_1 func7 (abstract_2 v150, abstract_1** v151, abstract_1** v152, abstract_1** v153) {

return ::func5(v152, v152, v152);
...
0    +---
0    | {vfptr}
4    | var8: DeletablePtrType{PtrType{AbstractType{1}}}
8    | var9: DeletablePtrType{PtrType{AbstractType{1}}}
12   | var10: DeletablePtrType{PtrType{AbstractType{1}}}
16   +---
*/
{
...
24   | {vfptr}
28   | var8: DeletablePtrType{PtrType{AbstractType{1}}}
32   | var9: DeletablePtrType{PtrType{AbstractType{1}}}
36   | var10: DeletablePtrType{PtrType{AbstractType{1}}}
40   +---
*/
{
...
0    | {vfptr}
4    | {vbptr}
8    | var128: DeletablePtrType{PtrType{AbstractType{1}}}
12   | var129: DeletablePtrType{PtrType{AbstractType{1}}}
16   | var130: DeletablePtrType{PtrType{AbstractType{1}}}
20   +---
...
36   | {vfptr}
40   | {vbptr}
44   | var26: DeletablePtrType{PtrType{AbstractType{1}}}
48   | var27: DeletablePtrType{PtrType{AbstractType{1}}}
52   | var28: DeletablePtrType{PtrType{AbstractType{1}}}
56   | var29: DeletablePtrType{PtrType{AbstractType{1}}}
60   +---
60   +--- (virtual base class C2)
60   | var38: DeletablePtrType{PtrType{AbstractType{1}}}
64   | var39: DeletablePtrType{PtrType{AbstractType{1}}}
68   | var40: DeletablePtrType{PtrType{AbstractType{1}}}
72   | var41: DeletablePtrType{PtrType{AbstractType{1}}}
76   +---
*/
{

...
struct C2 : public C0 {
/* method id 406 */ virtual void* func3 (C1 v18, C1 v19);
/* method id 407 */ C2 ();
...
/* method id 406 */ void* C2::func3 (C1 v18, C1 v19) {
C1 v20 = *((new C1 ()));
C1 v21 = *((new C1 ()));
C1 v22 = *((new C1 ()));
C1 v23 = *((new C1 ()));
...
52   | var25: ClassType{1}
84   | var26: ClassType{1}
116  | var27: ClassType{1}
148  +---
*/
{
...
116  | | var27: ClassType{1}
148  | +---
148  | var30: DeletablePtrType{PtrType{PtrType{PtrType{VoidType{}}}}}
152  | var31: PtrType{PtrType{PtrType{VoidType{}}}}
156  | var32: PtrType{PtrType{PtrType{VoidType{}}}}
160  | var33: ClassType{1}
192  +---
*/
{

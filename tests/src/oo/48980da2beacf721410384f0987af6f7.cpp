...
void func6 (C2 v139, C2 v140, C2 v141);
abstract_1* func7 (C2 v146);
// definitions
/* method id 400 */ C0::~C0 () {
v20 = v19;
v20 = v19;
...
0    | {vfptr}
4    | {vbptr}
8    | var137: ClassType{2}
68   | var138: ClassType{2}
128  | {vtordisp for vbase 0}
132  +---
132  +--- (virtual base class C0)
132  | {vfptr}
136  | var19: AbstractType{0}
140  | var20: AbstractType{0}
144  | var21: AbstractType{0}
148  | var22: AbstractType{0}
152  +---
152  +--- (virtual base class C1)
152  | {vfptr}
156  | {vbptr}
160  | var99: AbstractType{0}
164  | var100: AbstractType{0}
168  | var101: AbstractType{0}
172  +---
172  +--- (virtual base class C2)
172  | {vfptr}
176  | {vbptr}
180  | var113: AbstractType{0}
184  | var114: AbstractType{0}
188  +---
*/
{

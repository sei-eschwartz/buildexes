...
/* method id 409 */ void*** func0 (abstract_0*** v87, abstract_0*** v88, C2 v89);
/* method id 410 */ virtual void*** func0 (C2 v94, C2 v95);
...
abstract_2 func1 (C3 v100, C3 v101, C2 v102, C3 v103);
abstract_0* func2 (abstract_1 v107, C2 v108, C2 v109, C3 v110);
abstract_0* func3 (C2 v111, C3 v112, C2 v113, C3 v114);
abstract_0* func4 (C2 v119, C2 v120, C2 v121, C2 v122);
// definitions
/* method id 400 */ C0::C0 () {
...
/* method id 410 */ void*** C3::func0 (C2 v94, C2 v95) {
return new void** ();
...
4    | {vbptr}
8    | var96: ClassType{2}
60   | var97: ClassType{2}
112  | var98: AbstractType{1}
116  | var99: ClassType{2}
168  +---
168  +--- (virtual base class C0)
168  | var0: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
172  | var1: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
176  | var2: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
180  | var3: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
184  +---
184  +--- (virtual base class C1)
184  | {vfptr}
188  | {vbptr}
192  | var48: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
196  | var49: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
200  | var50: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
204  | var51: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
208  +---
208  +--- (virtual base class C2)
208  | {vbptr}
212  | var66: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
216  | var67: DeletablePtrType{PtrType{PtrType{AbstractType{0}}}}
220  +---
*/
{

...
/* method id 413 */ virtual void** func0 (C1 v36, C1 v37);
/* method id 414 */ ~C3 ();
...
void** func5 (C1 v54, abstract_0 v55, C3 v56, C3 v57);
void** func6 (C1 v59, C1 v60, C1 v61, C1 v62);
void** func7 (C1 v67, C1 v68, C1 v69, C1 v70);
void** func8 (C1 v75, abstract_0 v76, C1 v77, C1 v78);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
/* method id 413 */ void** C3::func0 (C1 v36, C1 v37) {
C1 v38 = *(((C1*) 0));
C1 v39 = *(((C1*) 0));
C1 v40 = *(((C1*) 0));
C1 v41 = *(((C1*) 0));
...
108  | | var22: ClassType{1}
136  | +---
136  | var50: ClassType{1}
164  | var51: ClassType{1}
192  | var52: ClassType{1}
220  | var53: ClassType{1}
248  +---

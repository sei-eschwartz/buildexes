...
abstract_2 func6 (abstract_3 v44, abstract_1 v45, abstract_4** v46, abstract_3 v47);
abstract_2 func7 (abstract_3 v49, C1 v50, abstract_1 v51, abstract_4*** v52);
abstract_6 func8 (abstract_1 v56, abstract_1 v57);
abstract_6 func9 ();
// definitions
...
delete (new C1 ());
return ::func7(abstract_3(), v37, abstract_1(), new abstract_4** ());
...
return ((new C1 ()))->C1::func0(v54, v54);
...
44   | var37: ClassType{1}
76   | {vtordisp for vbase 0}
80   +---
...
84   | {vfptr}
88   | {vbptr}
92   | var19: AbstractType{1}
96   | var20: AbstractType{5}
100  | var21: AbstractType{5}
104  | var22: AbstractType{5}
108  +---
*/
{
...
0    | {vbptr}
4    | var40: ClassType{1}
36   | var41: PtrType{PtrType{AbstractType{4}}}
40   | var42: PtrType{PtrType{AbstractType{4}}}
44   | var43: AbstractType{1}

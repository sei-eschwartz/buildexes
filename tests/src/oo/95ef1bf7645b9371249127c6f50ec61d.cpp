...
/* method id 409 */ virtual C0 func6 (C0* v8, C0* v9, C0* v10, C0* v11);
/* method id 410 */ virtual C0* func1 (C0* v16, C0* v17);
/* method id 411 */ C2 ();
...
/* method id 410 */ C0* C2::func1 (C0* v16, C0* v17) {
C0* v18 = (new C0 ());
C0* v19 = (new C0 ());
C0* v20 = (new C0 ());
(((C1*) 0))->C1::func2();
...
0    | {vbptr}
4    | var25: ClassType{1}
20   | var26: PtrType{PtrType{ClassType{0}}}
24   | var27: ClassType{1}

...
/* method id 408 */ C2 ();
/* method id 409 */ virtual abstract_0 func1 (abstract_2 v36);
...
/* method id 409 */ abstract_0 C2::func1 (abstract_2 v36) {
return abstract_0();
...
8    | +---
8    | var51: ClassType{1}
32   | var52: ClassType{1}
56   | var53: PtrType{AbstractType{0}}
60   +---
60   +--- (virtual base class C0)
60   | {vfptr}
64   | var15: AbstractType{3}
68   +---
*/
{

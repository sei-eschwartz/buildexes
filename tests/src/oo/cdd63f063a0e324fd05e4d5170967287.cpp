...
void** func6 (C1 v27, C1 v28, C1 v29, C1 v30);
void** func7 (C1 v35, C0 v36);
void*** func8 (C1 v37, C1 v38, C1 v39);
void** func9 (abstract_0 v40, abstract_0 v41, C1 v42, C0 v43);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
116  | {vbptr}
120  | var18: ClassType{1}
148  | var19: ClassType{1}
176  | var20: ClassType{1}
204  +---
*/
{

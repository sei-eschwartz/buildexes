...
/* method id 411 */ virtual abstract_0* func3 (C1 v61);
/* method id 412 */ virtual abstract_0* func4 (C1 v94, C1 v95);
...
abstract_0* func5 (C1 v104, C1 v105, C1 v106, C1 v107);
abstract_1** func6 (C0 v112, abstract_2* v113, C0 v114, abstract_2* v115);
abstract_0* func7 (abstract_3 v116, abstract_3 v117, C1 v118, C0 v119);
abstract_1* func8 ();
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 411 */ abstract_0* C3::func3 (C1 v61) {
C1 v62 = *((new C1 ()));
delete (new C0 ());
return ((abstract_0*) 0);

}
/* method id 412 */ abstract_0* C3::func4 (C1 v94, C1 v95) {
C1 v96 = *(((C1*) 0));
C1 v97 = *(((C1*) 0));
C1 v98 = *(((C1*) 0));
C1 v99 = *(((C1*) 0));
...
11   | | var3: ClassType{0}
12   | +---
12   | var100: ClassType{1}
24   | var101: ClassType{1}
36   | var102: ClassType{1}
48   | var103: ClassType{1}
60   +---
60   +--- (virtual base class C0)
60   +---
60   +--- (virtual base class C2)
60   | var44: ClassType{1}
72   | var45: ClassType{1}
84   | var46: ClassType{1}
96   | var47: ClassType{1}
108  +---
*/
{

...
/* method id 413 */ virtual abstract_0* func3 (C2 v47, C2 v48, C2 v49, C2 v50);
C3 (special_constructor);
};
abstract_0* func4 (abstract_4 v55, abstract_0** v56);
// definitions
...
/* method id 413 */ abstract_0* C3::func3 (C2 v47, C2 v48, C2 v49, C2 v50) {
C2 v51 = *(((C2*) 0));
C2 v52 = *(((C2*) 0));
C2 v53 = *(((C2*) 0));
C2 v54 = *(((C2*) 0));
...
48   | var34: PtrType{PtrType{AbstractType{0}}}
52   +---
*/
{

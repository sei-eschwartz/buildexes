...
abstract_1 func3 (abstract_1** v10, abstract_1** v11, abstract_1** v12);
// definitions
...
delete (new C0 ());
return (((C0*) 0))->C0::func1(new abstract_1* (), v1);

}
/* method id 402 */ abstract_1 C0::func0 (abstract_1** v4, abstract_1** v5) {
((new C0 ()))->C0::func1(v5, abstract_0());
((new C0 ()))->C0::func1(v5, abstract_0());
((new C0 ()))->C0::func1(v5, abstract_0());
((new C0 ()))->C0::func1(v5, abstract_0());
return ::func3(v5, v5, v5);
...
((new C0 ()))->C0::func1(v11, abstract_0());
((new C0 ()))->C0::func1(v11, abstract_0());
((new C0 ()))->C0::func1(v11, abstract_0());
((new C0 ()))->C0::func1(v11, abstract_0());
return (((C0*) 0))->C0::func1(v10, abstract_0());

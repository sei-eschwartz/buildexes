...
void func6 (C0* v95, C0* v96, C0* v97, C0* v98);
abstract_0 func7 (C0* v103, abstract_1 v104);
C0* func8 (C0* v108, C0* v109, C0* v110, C0* v111);
void func9 (C0* v116, abstract_1 v117);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
C0* v5 = &(*((new C0 ())));
delete (new C1 ());
return ::func7((new C0 ()), abstract_1());
...
::func7(v12, abstract_1());
::func7(v12, abstract_1());
::func7(v12, abstract_1());
::func7(v12, abstract_1());
return ::func9(v12, v11);
...
return (((C1*) 0))->C1::func3((new C0 ()), ((abstract_0*) 0));
...
0    | | {vfptr}
4    | +---
4    | var49: PtrType{AbstractType{0}}
8    +---
*/
{
...
12   | | var13: PtrType{ClassType{0}}
16   | +---
16   | var92: PtrType{ClassType{0}}
20   | var93: PtrType{ClassType{0}}
24   | var94: AbstractType{1}
28   +---

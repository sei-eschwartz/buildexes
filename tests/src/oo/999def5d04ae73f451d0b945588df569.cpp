...
/* method id 405 */ C0* func2 (C1 v5, C1 v6, C1 v7, C1 v8);
/* method id 406 */ C2 ();
...
/* method id 405 */ C0* C2::func2 (C1 v5, C1 v6, C1 v7, C1 v8) {
C1 v9 = *((new C1 ()));
C1 v10 = *((new C1 ()));
C1 v11 = *((new C1 ()));
C1 v12 = *((new C1 ()));
...
52   | var14: PtrType{AbstractType{0}}
56   | var15: AbstractType{1}
60   | var16: ClassType{1}
88   +---

...
struct C3 : public C2 {
/* method id 411 */ C3 ();
/* method id 412 */ void func0 (C1 v23, C1 v24, C1 v25, abstract_0 v26);
/* method id 413 */ virtual void func4 (void**** v27);
/* method id 414 */ void** func0 (C1 v28, void**** v29);
...
/* method id 412 */ void C3::func0 (C1 v23, C1 v24, C1 v25, abstract_0 v26) {
return;

}
/* method id 413 */ void C3::func4 (void**** v27) {
return (&(v37))->C1::func0();

}
/* method id 414 */ void** C3::func0 (C1 v28, void**** v29) {
C1 v30 = *(((C1*) 0));
C1 v31 = *(((C1*) 0));
C1 v32 = *(((C1*) 0));
C2 v33 = *((new C2 ()));
...
108  | | var22: ClassType{1}
136  | +---
136  | var34: ClassType{1}
164  | var35: ClassType{2}
304  | var36: ClassType{1}
332  | var37: ClassType{1}
360  +---
360  +--- (virtual base class C0)
360  | {vfptr}
364  +---
*/
{

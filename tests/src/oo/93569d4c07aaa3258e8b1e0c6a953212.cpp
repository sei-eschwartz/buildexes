...
abstract_0* func6 (abstract_0** v26, C1 v27, C1 v28, C1 v29);
// definitions
...
delete (new C0 ());
return ::func6(new abstract_0* (), v23, v23, v23);
...
0    | {vbptr}
4    | var24: ClassType{1}
28   | var25: ClassType{1}
52   | {vtordisp for vbase 0}
56   +---
56   +--- (virtual base class C0)
56   | {vfptr}
60   | var4: PtrType{PtrType{AbstractType{0}}}
64   +---
64   +--- (virtual base class C1)
64   | {vbptr}
68   | var8: PtrType{PtrType{AbstractType{0}}}
72   | var9: PtrType{PtrType{AbstractType{0}}}
76   +---
76   +--- (virtual base class C2)
76   | {vfptr}
80   | var22: ClassType{1}
104  | var23: ClassType{1}
128  +---
*/
{

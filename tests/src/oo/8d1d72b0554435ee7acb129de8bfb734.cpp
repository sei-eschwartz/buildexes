...
abstract_0 func9 (C0 v24, C0 v25, C0 v26, abstract_1 v27);
abstract_0 func10 (abstract_1 v32, C0 v33, C0 v34, C1 v35);
abstract_0 func11 (C0 v36, C1 v37, C0 v38, C1 v39);
abstract_0 func12 (C0 v40, abstract_1 v41, C0 v42, C1 v43);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
return ::func9(v13, v13, v12, abstract_1());
...
return ::func9(v9, v9, v9, abstract_1());
...
delete (new C0 ());
return ::func10(abstract_1(), v24, v25, v29);
...
v33 = v34;
v33 = v34;
return ::func9(v34, v33, v34, v32);

}
abstract_0 func11 (C0 v36, C1 v37, C0 v38, C1 v39) {

return ::func9(v36, v36, v36, abstract_1());

}
abstract_0 func12 (C0 v40, abstract_1 v41, C0 v42, C1 v43) {

return ::func10(abstract_1(), v42, v42, v43);
...
48   | {vfptr}
52   | {vbptr}
56   | var12: ClassType{0}
60   | var13: ClassType{0}
64   | var14: PtrType{AbstractType{0}}
68   | var15: PtrType{AbstractType{0}}
72   +---
*/
{
...
16   | | var19: ClassType{1}
44   | +---
44   | var20: ClassType{1}
72   | var21: PtrType{AbstractType{0}}
76   | var22: ClassType{1}
104  | var23: ClassType{0}
108  +---
...
112  | {vfptr}
116  | {vbptr}
120  | var12: ClassType{0}
124  | var13: ClassType{0}
128  | var14: PtrType{AbstractType{0}}
132  | var15: PtrType{AbstractType{0}}
136  +---
*/
{

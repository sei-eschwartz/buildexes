...
void func6 (C2 v132, C2 v133, abstract_2 v134, abstract_0 v135);
abstract_3 func7 (C2 v138, C3 v139, C1 v140);
abstract_1* func8 ();
abstract_3 func9 (C2 v142, abstract_3** v143, abstract_3** v144, C2 v145);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
32   | {vfptr}
36   | {vbptr}
40   | var99: AbstractType{0}
44   | var100: AbstractType{0}
48   | var101: AbstractType{0}
52   +---
52   +--- (virtual base class C2)
52   | {vfptr}
56   | {vbptr}
60   | var113: AbstractType{0}
64   | var114: AbstractType{0}
68   +---
*/
{

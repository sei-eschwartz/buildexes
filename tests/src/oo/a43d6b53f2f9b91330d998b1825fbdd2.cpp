...
/* method id 408 */ C2 ();
/* method id 409 */ void func4 (C1 v11, void**** v12, C1 v13, void**** v14);
/* method id 410 */ virtual abstract_0 func4 (C1 v16, C1 v17);
...
/* method id 409 */ void C2::func4 (C1 v11, void**** v12, C1 v13, void**** v14) {
C1 v15 = *((new C1 ()));
return;

}
/* method id 410 */ abstract_0 C2::func4 (C1 v16, C1 v17) {
return abstract_0();
...
52   | var19: ClassType{1}
80   | var20: ClassType{1}
108  | var21: ClassType{1}
136  +---
...
108  | | var21: ClassType{1}
136  | +---
136  | var23: ClassType{1}
164  | var24: ClassType{2}
304  | var25: ClassType{2}
444  +---

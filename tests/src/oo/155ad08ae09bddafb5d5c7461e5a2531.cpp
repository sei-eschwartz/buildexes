...
/* method id 412 */ virtual abstract_0 func4 (abstract_5*** v24);
/* method id 413 */ virtual abstract_1 func4 (abstract_6 v29, abstract_0** v30);
/* method id 414 */ abstract_0* func0 (abstract_5*** v31, abstract_5*** v32, abstract_5** v33, abstract_0** v34);
/* method id 415 */ C3 ();
...
return (((C1*) 0))->C1::func0(new abstract_0* ());
...
abstract_5*** v22 = new abstract_5** ();
abstract_5*** v23 = new abstract_5** ();
return abstract_0();

}
/* method id 412 */ abstract_0 C3::func4 (abstract_5*** v24) {
abstract_5*** v25 = new abstract_5** ();
abstract_5** v26 = new abstract_5* ();
abstract_6 v27 = abstract_6();
abstract_6 v28 = abstract_6();
return abstract_0();

}
/* method id 413 */ abstract_1 C3::func4 (abstract_6 v29, abstract_0** v30) {
return abstract_1();

}
/* method id 414 */ abstract_0* C3::func0 (abstract_5*** v31, abstract_5*** v32, abstract_5** v33, abstract_0** v34) {
return new abstract_0 ();
...
0    | {vfptr}
4    | {vbptr}
8    | var17: PtrType{PtrType{AbstractType{0}}}
12   | var18: PtrType{PtrType{AbstractType{0}}}
16   | var19: PtrType{PtrType{AbstractType{0}}}
20   | var20: DeletablePtrType{PtrType{PtrType{AbstractType{5}}}}
...
0    | {vfptr}
4    | {vbptr}
8    | var35: AbstractType{6}
12   | var36: DeletablePtrType{PtrType{PtrType{AbstractType{5}}}}
...
40   | {vfptr}
44   | {vbptr}
48   | var17: PtrType{PtrType{AbstractType{0}}}
52   | var18: PtrType{PtrType{AbstractType{0}}}
56   | var19: PtrType{PtrType{AbstractType{0}}}
60   | var20: DeletablePtrType{PtrType{PtrType{AbstractType{5}}}}
64   +---
*/
{

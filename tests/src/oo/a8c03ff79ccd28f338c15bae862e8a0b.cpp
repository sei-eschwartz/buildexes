...
abstract_0 func7 (abstract_1 v40, C0* v41);
C0 func8 ();
C0* func9 (abstract_1 v43);
C0* func10 (abstract_0* v45);
// definitions
/* method id 400 */ C0::~C0 () {
::func7(abstract_1(), &(::func8()));
return;

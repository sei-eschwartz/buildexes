...
/* method id 408 */ abstract_0 func3 (C1 v27, C1 v28);
...
abstract_0 func4 (C1 v85, C0 v86, C1 v87, C1 v88);
abstract_0 func5 (C1 v90);
abstract_0 func6 (C1 v95);
abstract_0 func7 (C1 v99, C1 v100, C1 v101, C1 v102);
// definitions
/* method id 400 */ C0::~C0 () {
::func5(*(((C1*) 0)));
::func5(*(((C1*) 0)));
...
/* method id 408 */ abstract_0 C2::func3 (C1 v27, C1 v28) {
C1 v29 = *(((C1*) 0));
C1 v30 = *(((C1*) 0));
C1 v31 = *(((C1*) 0));
C1 v32 = *(((C1*) 0));
...
0    | {vbptr}
4    | var81: ClassType{1}
16   | var82: ClassType{1}
28   | var83: ClassType{1}
40   | var84: ClassType{1}
52   +---
...
64   | {vfptr}
68   | var33: ClassType{1}
80   | var34: ClassType{1}
92   | var35: ClassType{1}
104  +---
*/
{

...
/* method id 410 */ C2 ();
/* method id 411 */ virtual C0* func1 (C0* v20);
...
C0* func8 ();
C0 func9 (C0* v26);
C0 func10 (C0* v27, C0* v28, C0* v29, C0* v30);
C0* func11 (C0* v31);
// definitions
/* method id 400 */ C0::~C0 () {
((new C1 ()))->C1::func3();
...
v3 = (new C0 ());
v3 = (new C0 ());
return ::func10((new C0 ()), (new C0 ()), (new C0 ()), (new C0 ()));
...
/* method id 411 */ C0* C2::func1 (C0* v20) {
delete (new C2 ());
return v24;

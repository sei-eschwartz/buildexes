...
/* method id 407 */ C3 ();
/* method id 408 */ virtual abstract_0* func1 (abstract_0* v13);
/* method id 409 */ virtual abstract_0* func1 (abstract_0* v21, abstract_0*** v22, C1 v23, abstract_0* v24);
...
/* method id 408 */ abstract_0* C3::func1 (abstract_0* v13) {
C1 v14 = *(&(*(((C1*) 0))));
C1 v15 = *(&(*(((C1*) 0))));
...
/* method id 409 */ abstract_0* C3::func1 (abstract_0* v21, abstract_0*** v22, C1 v23, abstract_0* v24) {
delete (new C3 ());
return new abstract_0 ();
...
4    | {vbptr}
8    | var25: ClassType{2}
16   | var26: ClassType{1}
24   | var27: ClassType{2}
32   | var28: ClassType{2}

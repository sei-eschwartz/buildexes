...
/* method id 410 */ C0* func5 (C1 v12, C1 v13, C1 v14);
...
/* method id 410 */ C0* C2::func5 (C1 v12, C1 v13, C1 v14) {
C1 v15 = *(&(*((new C1 ()))));
C1 v16 = *(&(*((new C1 ()))));
(&(*(((C2*) 0))))->C2::func0();
(&(*(((C2*) 0))))->C2::func0();
...
52   | var18: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}

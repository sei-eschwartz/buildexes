...
/* method id 416 */ abstract_3 func0 (C1 v63, abstract_4 v64);
C3 (special_constructor);
};
// definitions
/* method id 400 */ abstract_1 C0::func0 (abstract_0 v0) {
return (&(*(((C0*) 0))))->C0::func1(new abstract_1* ());
...
8    | {vfptr}
12   | {vbptr}
16   | var20: DeletablePtrType{PtrType{AbstractType{1}}}
20   | var21: AbstractType{0}
24   | var22: DeletablePtrType{PtrType{AbstractType{1}}}
28   | var23: DeletablePtrType{PtrType{AbstractType{1}}}
32   +---
32   +--- (virtual base class C2)
32   | {vfptr}
36   | {vbptr}
40   | var40: DeletablePtrType{PtrType{AbstractType{1}}}
44   +---
*/
{

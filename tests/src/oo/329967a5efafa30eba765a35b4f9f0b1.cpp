...
abstract_0 func5 ();
abstract_0 func6 (C0 v72, abstract_0* v73);
abstract_0 func7 ();
abstract_0 func8 (C0 v75);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
return ::func6(*(((C0*) 0)), new abstract_0 ());
...
return ::func6(v6, new abstract_0 ());
...
0    | | {vfptr}
4    | +---
4    | var67: AbstractType{3}
8    | var68: PtrType{AbstractType{0}}
12   +---
*/
{

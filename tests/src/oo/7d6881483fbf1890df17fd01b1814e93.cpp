...
/* method id 410 */ virtual abstract_0**** func8 (abstract_1 v23, abstract_0**** v24, C1 v25);
C3 (special_constructor);
};
abstract_0*** func10 ();
abstract_0* func11 (C3 v34, C3 v35, abstract_1 v36, abstract_0**** v37);
abstract_0* func12 (abstract_3 v38, abstract_0**** v39, C3 v40, C1 v41);
C0** func13 (C3 v43, C1 v44, C3 v45, abstract_3 v46);
// definitions
/* method id 400 */ C0::~C0 () {
return;
...
/* method id 410 */ abstract_0**** C3::func8 (abstract_1 v23, abstract_0**** v24, C1 v25) {
...
12   | {vfptr}
16   | {vbptr}
20   | var8: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
24   +---
24   +--- (virtual base class C2)
24   | {vfptr}
28   | {vbptr}
32   | var11: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
36   | var12: DeletablePtrType{PtrType{PtrType{PtrType{AbstractType{0}}}}}
40   | var13: AbstractType{1}

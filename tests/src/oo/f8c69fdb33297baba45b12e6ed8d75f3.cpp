...
void func6 (void** v28);
abstract_1 func7 (C1 v29, C1 v30);
// definitions
/* method id 400 */ C0::~C0 () {
delete (new C1 ());
return;
...
108  | | var22: ClassType{1}
136  | +---
136  | var24: AbstractType{0}
140  | var25: ClassType{1}
168  | var26: ClassType{1}
196  | var27: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}
200  +---
200  +--- (virtual base class C0)
200  | {vfptr}
204  +---
*/
{

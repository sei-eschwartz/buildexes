...
/* method id 411 */ virtual void func1 (C1 v10, abstract_2 v11, abstract_0**** v12, C1 v13);
/* method id 412 */ C2 ();
...
/* method id 410 */ abstract_0 C2::func3 () {
return abstract_0();

}
/* method id 411 */ void C2::func1 (C1 v10, abstract_2 v11, abstract_0**** v12, C1 v13) {
...
0    +---
0    | {vbptr}
4    | var6: DeletablePtrType{PtrType{DeletablePtrType{PtrType{AbstractType{0}}}}}
8    +---
...
8    | {vbptr}
12   | var6: DeletablePtrType{PtrType{DeletablePtrType{PtrType{AbstractType{0}}}}}
16   +---
*/
{
...
class C3    size(12)
0    +---
0    | var16: DeletablePtrType{PtrType{DeletablePtrType{PtrType{AbstractType{0}}}}}
4    | var17: ClassType{1}
12   +---
*/
{

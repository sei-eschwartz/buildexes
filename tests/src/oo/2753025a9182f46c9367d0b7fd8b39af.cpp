...
void func2 (void* v21, void* v22, void* v23);
// definitions
/* method id 400 */ C0::C0 () {
...
0    +---
0    | {vbptr}
4    | {vtordisp for vbase 2}
8    +---
8    +--- (virtual base class C2)
8    | {vfptr}
12   | +--- (base class C1)
12   | | var1: PtrType{VoidType{}}
16   | | var2: PtrType{VoidType{}}
20   | | var3: ClassType{0}
21   | | var4: ClassType{0}
22   | | alignment: 
24   | +---
24   | var18: PtrType{VoidType{}}
28   | var19: ClassType{0}
29   | var20: ClassType{0}
30   | alignment: 
32   +---
32   | alignment: Additional padding between virtual bases 2, which ends with a zero-sized object, and 0, which leads with zero sized base.

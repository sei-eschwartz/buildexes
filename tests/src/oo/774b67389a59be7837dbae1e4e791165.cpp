...
abstract_4 func5 (abstract_1 v59, C1 v60);
abstract_4 func6 (abstract_3 v63, abstract_1 v64, C1 v65);
abstract_4 func7 (abstract_1 v69, C1 v70);
abstract_2 func8 ();
// definitions
...
C1 v35 = *(&(*((new C1 ()))));
C1 v36 = *(&(*((new C1 ()))));
return ::func6(abstract_3(), v58, v35);
...
return ::func7(v67, v68);

}
abstract_4 func7 (abstract_1 v69, C1 v70) {
abstract_1 v71;

return ::func6(abstract_3(), v69, v70);
...
8    | | var27: AbstractType{1}
12   | +---
12   | var55: AbstractType{8}
16   | var56: ClassType{1}
40   | var57: ClassType{1}
64   | var58: AbstractType{1}
...
76   | {vbptr}
80   | var20: PtrType{AbstractType{2}}
84   | var21: AbstractType{0}
88   | var22: AbstractType{0}
92   +---
*/
{

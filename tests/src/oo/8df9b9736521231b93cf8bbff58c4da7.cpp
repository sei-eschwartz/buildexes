...
struct C2 : public C1 {
/* method id 406 */ void**** func2 (C0 v5, C0 v6, C0 v7, C0 v8);
/* method id 407 */ C2 ();
...
void** func3 (C0 v18);
void*** func4 (C0 v21, void**** v22, C0 v23, void**** v24);
abstract_0 func5 (C0 v26);
// definitions
/* method id 400 */ C0::~C0 () {
::func3(*((C0*)(((C1*) 0))));
::func3(*((C0*)(((C1*) 0))));
...
/* method id 406 */ void**** C2::func2 (C0 v5, C0 v6, C0 v7, C0 v8) {
return new void*** ();
...
16   | | var4: ClassType{0}
20   | +---
20   | var17: DeletablePtrType{PtrType{DeletablePtrType{PtrType{VoidType{}}}}}
24   +---

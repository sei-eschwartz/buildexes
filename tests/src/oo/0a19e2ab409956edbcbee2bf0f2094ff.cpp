...
return ((new C1 ()))->C1::func4(v19, v19);
...
return (((C2*) 0))->C2::func1(abstract_5(), v12);
...
(&(*((new C3 ()))))->C3::func5();
(&(*((new C3 ()))))->C3::func5();
return (((C2*) 0))->C2::func0(abstract_6(), v65);
...
0    | {vfptr}
4    | {vbptr}
8    | var117: AbstractType{1}
12   | var118: AbstractType{1}
16   | var119: AbstractType{1}
20   +---
20   +--- (virtual base class C0)
20   | {vfptr}
24   | var17: AbstractType{1}
28   | var18: AbstractType{1}
32   | var19: AbstractType{4}
36   | var20: AbstractType{4}
40   +---
*/
{

...
/* method id 408 */ virtual C0 func1 (C0* v337, abstract_5 v338);
...
C0 func2 (abstract_5 v347);
C0 func3 (C0* v351, C0* v352, abstract_0 v353, C0* v354);
C0 func4 (abstract_5 v356, C0* v357, abstract_1 v358, C0* v359);
C0 func5 (C0* v362, abstract_5 v363);
// definitions
/* method id 400 */ C0::C0 () {
...
delete (new C1 ());
return ::func3(v30, v30, abstract_0(), v30);

}
/* method id 408 */ C0 C3::func1 (C0* v337, abstract_5 v338) {
abstract_4 v339 = abstract_4();
C0* v340 = ((C0*) 0);
abstract_5 v341 = abstract_5();
C0* v342 = ((C0*) 0);
return *(v342);
...
4    | | {vbptr}
8    | +---
8    | var343: AbstractType{4}
12   | var344: PtrType{ClassType{0}}
16   | var345: AbstractType{5}
20   | var346: PtrType{ClassType{0}}
24   +---

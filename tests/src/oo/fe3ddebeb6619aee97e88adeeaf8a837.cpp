...
delete (new C1 ());
return ((new C1 ()))->C1::func2(v8, v8, v8);
...
/* method id 409 */ C3::C3 () {
abstract_1 v166 = abstract_1();
abstract_1 v167 = abstract_1();
abstract_1 v168 = abstract_1();
C0 v169 = *(((C0*) 0));
return;

}
/* method id 410 */ C3::~C3 () {
abstract_1 v175 = abstract_1();
abstract_1 v176 = abstract_1();
abstract_1 v177 = abstract_1();
...
0    +---
0    | {vbptr}
4    | var162: AbstractType{1}
8    | var163: AbstractType{1}
12   | var164: AbstractType{1}
16   | var165: AbstractType{1}
20   +---
...
0    +---
0    | {vbptr}
4    | var187: AbstractType{1}
8    | var188: AbstractType{1}
12   | var189: AbstractType{1}
16   +---
16   +--- (virtual base class C0)
16   | {vfptr}
20   +---
